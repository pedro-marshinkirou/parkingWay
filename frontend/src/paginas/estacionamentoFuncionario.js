...
function EstacFunc() {
    ...
    async function fetchTableData() {
        ...
        const handleditEstac = () => {
            navigation.navigate('EditarEstacionamento', { data });
        };
    ...
    return (
        <View style={styles.wrapper}>
            <View style={styles.contentLogin}>
                ...
                <Text style={styles.heading}>Estacionamento</Text>
                    ...
                    <ScrollView>
                        {tableData.map((estac, index) => {
                            return <View style={styles.heading} key={estac._id}>
                                    ...
                                    <Text style={styles.Xheading}>Descrição:{estac.descricao}</Text>
                                    ...
                                    <TouchableOpacity style={styles.btn} onPress={handleditEstac}>
                                        <Text style={styles.btnText}>Editar Estacionamento</Text>
                                    </TouchableOpacity>
                                </View>
                        })}
                    </ScrollView>

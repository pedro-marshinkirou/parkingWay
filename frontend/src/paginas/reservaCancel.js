...
function ReservasCanceladas() {
    ...
    async function fetchTableData() {
        ...
        try {
            const response = await reservasService.getReservaCanceladaBYID(estacionamento._id);
    ...
    return (
        <View style={styles.wrapper}>
            <View style={styles.contentLogin}>
                ...
                <Text style={styles.heading}>Reservas Canceladas</Text>
                <SafeAreaView style={styles.container}>
                    <ScrollView>
                        {tableData.map((Reserva, index) => {
                            return <View style={styles.heading} key={Reserva._id}>
                                <Text style={styles.Xheading}>Data da Reserva:{Reserva.data}</Text>
                                ...
                                <Text style={styles.Xheading}>------------------------</Text>
                            </View>
                        })}

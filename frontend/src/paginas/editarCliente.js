...
function EditarCliente() {
    ...
    const [cliente, setTableData] = useState([]);
    ...
    async function fetchTableData() {
        ...
        const handleSubmit = async () => {
            try {
              var id = data._id;
              await clienteService.updtCliente(id, cliente);
        ...
        <View style={styles.wrapper}>
            <View style={styles.contentLogin}>
                ...
                <SafeAreaView style={styles.container}>
                    <ScrollView>
                        {cliente.map((clit, index) => {
                            return <View style={styles.heading} key={clit._id}>
                                    <TextInput
                                        style={styles.input}
                                        placeholder="Nome"
                                    ...
                                    <TextInput
                                        ...
                                        placeholderTextColor="#800080"
                                        value={clit.modelo}
                                        onChange={(text) => handleChange('modelo', text)}
                                        required
                                        />
                                    <TextInput
                                        style={styles.input}
                                        ...
                                        placeholderTextColor="#800080"
                                        value={clit.placa}
                                        onChange={(text) => handleChange('placa', text)}
                                        required
                                        />
